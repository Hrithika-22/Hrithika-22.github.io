    ...
    <div class="navAndContent">
      <div class="navbar navbar-phone col-navbar-tablet col-navbar-desktop">
        <div class="navbarInner">
          <ul>
            <li><a href="backstore_p11.html">Home</a></li>
            <br><br>
            <b>Backstore</b>
      ...
      <div class="content-desktop content-tablet content-phone">
        ...
        <div class="data col-11 col-s-11">
          ...
          foreach ($products as $product) {
            ...
            $img = $product->imgpath;
            $url = htmlspecialchars("productedit.php?ID=". $id );
            ...
            $html = '<div class="entry">
                    ...
                    <div class="amount">
                      <p>' . $inventory . '</p>
                        <button onclick="location.href = \'' . $url . '\'" class="btn" type="button">Edit</button>
                        <button id= "' . $id . '" class="deletebtn" type="button">Delete</button>
                    </div>
                    </div>';
           echo $html;
